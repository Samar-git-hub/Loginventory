...
export default function DispatchModal({ item, committeeName, onConfirm, onClose, isLoading, error }) {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-xl font-bold font-montserrat text-yale mb-1">Dispatch Items</h2>
